...
public class ScheduledResourceFactoryBuildingTaskAdapter {
	private ScheduledResourceFactoryBuildingTask scheduledResourceFactoryBuildingTask;
	...
	public static List<ScheduledResourceFactoryBuildingTaskAdapter> adapt(
		...
		return (List) scheduledResourceFactoryBuildingTasks.stream().map((srfbt) -> {
			return new ScheduledResourceFactoryBuildingTaskAdapter(srfbt, lanugageProperties);
		}).collect(Collectors.toList());
	}

	public ScheduledResourceFactoryBuildingTaskAdapter(
			ScheduledResourceFactoryBuildingTask scheduledResourceFactoryBuildingTask,
			Map<String, String> languageProperties) {
		this.scheduledResourceFactoryBuildingTask = scheduledResourceFactoryBuildingTask;
		this.languageProperties = languageProperties;
		this.prepareBuildingTaskName();
		this.startDate = scheduledResourceFactoryBuildingTask.getStartDate();
		this.executionDate = scheduledResourceFactoryBuildingTask.getExecutionDate();
		this.id = scheduledResourceFactoryBuildingTask.getId();
	}
	...
	private String prepareMapKey() {
		String key = "resource.factory.buildingtype.bytypesid."
				+ this.scheduledResourceFactoryBuildingTask.getResourceTypeId();
		return key;
	}
}
